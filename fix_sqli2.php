...
// ============================================================
// GenerateHook - Update parametercount (new=true branch) — exact whitespace
// ============================================================
...
// ============================================================
// AuftragAutoversandBerechnen porto_ok=1 + portoFreeLimit
// ============================================================
...
// ============================================================
// ReplacePreisgruppe SELECT id (multi-line)
// ============================================================
...
// ============================================================
// checkkeinportocheck (uses real_escape_string — fix to named param)
// ============================================================
...
rep($content,
    ...
    "    \$zahlungsweisenmodule = \$this->app->DatabaseService->select(\"SELECT id, modul, verhalten FROM zahlungsweisen WHERE type = :type AND (projekt = :projekt OR projekt = 0) ORDER BY projekt = :projekt2 DESC LIMIT 1\", ['type' => \$zahlungsweise, 'projekt' => (int) \$projekt, 'projekt2' => (int) \$projekt]);",
    'AuftragAutoversandBerechnen SELECT zahlungsweisenmodule'
);
